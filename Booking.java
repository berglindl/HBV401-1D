public class Booking{
	...
	*/
	...
	//grabs the information sent over by Trip via getInfo
	public void getBInfo(Object[] trip1, trip2, trip3, trip4, trip5, trip6, trip7, trip8, trip9, trip10, trip11, trip12, trip13, trip14
		...
		Scanner userInput = new Scanner(System.in);
	    {
	        ...
	        switch(tripNum){
	            ...
	            case 1: Trip[0]; //eða Trip[trip1] EÐA Trip.Inventory[0] eða eitthvað álíka. i dunno. 
